...
Data, code and an interactive dashboard for the study **"Paving an Extractive Path? Infrastructure, Human Capital and Environmental Pressure in Sub-Saharan Africa"** (Tackie, Adams, Maisuh & Moore).
